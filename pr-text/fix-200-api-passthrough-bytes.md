...
- 10 `/api` endpoints answered byte-identically to master and to the backend itself.
- The 66 MB function listing took 11.1 s instead of 18.9 s, and the 34.7 MB unique blocks result 0.54 s instead of 2.93 s.
- A missing id answers with the backend's JSON message instead of an empty body.
